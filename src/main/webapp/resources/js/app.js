document.addEventListener("DOMContentLoaded", function () {
    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            let institutions = document.querySelector('input[name="institution"]:checked').value;
            ...
            document.getElementById('phoneSummary').innerText = phone;
            document.getElementById('timeSummary').innerText = time;
            document.getElementById('commentSummary').innerText = comment;
            document.getElementById('dateSummary').innerText = data;
            document.getElementById('quantitySummary').innerText = quantity + ' worki: ' + categoriesArray.join(' oraz ');
            document.getElementById('institutionSummary').innerText = institutions;
